          ...
          <div className="flex items-center">
            ...
            <span className="text-sm">
              {translations?.dojos?.explanation?.open_mat ||
                "Open Mat - Open training sessions welcoming people from different gyms"}
            </span>
          </div>
          <div className="flex items-center">
            <span
            ...
            <span className="text-sm">
              {translations?.dojos?.explanation?.free_guest ||
                "Free Guest Training - If you're traveling to Switzerland from another country, you can train with us for free"}
            </span>
          </div>
        </div>
      </div>

      {/* Add your gym section */}
